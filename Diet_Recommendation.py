...
if clicked:
    if gender == "Select an option" or food_pref == "Select an option":
        ...
        st.write(gemini_meal_plan) <span style="color: #D9534F;">Your Personalized AI Diet Planner</span></h4>'
    '</div>',
    unsafe_allow_html=True
)
...
if clicked:
    if gender == "Select an option" or food_pref == "Select an option":
        ...
        # Call Gemini AI for meal recommendations
        gemini_meal_plan = get_gemini_recommendation(prompt)
        st.write(gemini_meal_plan)Your Personalized AI Diet Planner</span></h4>'
    '</div>',
    unsafe_allow_html=True
)
